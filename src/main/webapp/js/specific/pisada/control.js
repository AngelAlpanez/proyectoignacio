...
var pisadaControl = function (strClase) {
    this.clase = strClase;
};
pisadaControl.prototype = new control('pisada');
pisadaControl.prototype.getClassNamePisada = function () {
    return this.getClassName() + "Control";
};
var oPisadaControl = new pisadaControl('pisada');
...
control.prototype.new = function (place, objParams, oModel, oView) {
    ...
    if (objParams) {
        ...
        window[oModelo].loadAggregateViewOne(objParams["sytemfiltervalue"]);
        $('#pisada').val(window[oModelo].getCachedOne().pisada);
    }
