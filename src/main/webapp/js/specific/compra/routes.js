...
//    });
      ...
      Path.map("#/compra").to(function () {
        $('#indexContenidoJsp').spinner();
        ocompraControl.listCuadros($('#indexContenido'), param().defaultizeUrlObjectParameters({}), null, ocompraModel, ocompraView);
    ...
    Path.map("#/compra/list/:url").to(function () {
        ...
        ocompraControl.listCuadros($('#indexContenido'), paramsObject, null, ocompraModel, ocompraView);
        $('#indexContenidoJsp').empty();
        return false;
    });
