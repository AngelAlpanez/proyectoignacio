...
var marcasControl = function (strClase) {
    this.clase = strClase;
};
marcasControl.prototype = new control('marcas');
marcasControl.prototype.getClassNameMarcas = function () {
    return this.getClassName() + "Control";
};
var oMarcasControl = new marcasControl('marcas');


marcasControl.prototype.listCuadros = function (place, objParams, callback, oModel, oView) {
    var thisObject = this;
