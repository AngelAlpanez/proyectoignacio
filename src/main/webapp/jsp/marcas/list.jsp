...
<%@page import="net.daw.dao.generic.specific.implementation.MarcasDaoGenSpImpl"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.Iterator"%>
<%
    ArrayList<String> alColumnsNames;
    Iterator<String> oIterador;
    String strNombreMantenimiento = "marcas";
                    ...
                    <div class="row">
                        ...
                        function changeFunc() {
                         ...
                         alert(selectedValue);
                                        ...
                                        <select id="inputFiltervalue" data-native-menu="false" class="filterable-select">
                                            <option>Selecciona Marca</option>
                                            <option value="adidas">Adidas</option>
                                            <option value="2">Asics</option>
                                            <option value="3">Brooks</option>
                                            <option value="4">Inov8</option>
                                            <option value="5">Joma</option>
                                            <option value="6">K-Swiss</option>
                                            <option value="7">Kelme</option>
                                            <option value="8">La Sportiva</option>
